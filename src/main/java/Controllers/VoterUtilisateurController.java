...
public class VoterUtilisateurController {
    @FXML
    ...
    @FXML
    void VoterConcours(ActionEvent event) {
        ...
        if (c != null) {
            ...
            alert1.setContentText("Do you really want to vote for this concour");
            ...
            alert1.setResultConverter(buttonType -> {
                if (buttonType == okButton) {
                    ...
                    Votes v=new Votes(sqlDate,c.getReference(),user);
                    if (serV.Unique(v)) {
                        try {
                            serV.add(v);
                        } catch (SQLException e) {
                        ...
                        alert2.setContentText("You already voted");
                        alert2.showAndWait();
                    }
