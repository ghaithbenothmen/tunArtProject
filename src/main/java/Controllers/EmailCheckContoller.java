...
public class EmailCheckContoller implements Initializable {
    ...
    private void passwrd_reset(ActionEvent event) throws SQLException {
        ...
        if (us.existemail(email_check.getText())==true){
            ...
            mail.send(email_check.getText(), "code de vérification", "le code est: "+String.valueOf(code2), "essid.yassine11@gmail.com", "giqc soyo nhjd lcqg");
